    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ban_reason', models.TextField(blank=True, help_text='Reason for global ban', null=True)),
                ('banned_at', models.DateTimeField(blank=True, help_text='When the global ban was applied', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subforum', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_bans', to='notes.subforum')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subforum_bans', to=settings.AUTH_USER_MODEL)),
            ],
            options={
